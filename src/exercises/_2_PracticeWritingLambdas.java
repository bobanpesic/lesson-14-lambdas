...
class _2_PracticeWritingLambdas {
	...
	Function<String, String> REMOVE_VOWELS_LAMBDA = string -> string.replaceAll("[AEIOUaeiou]", "");
	Function<Integer, Integer> DOUBLE_LAMBDA = x -> 2 * x;
	...
	Function<String, String> BLACKOUT_LAMBDA = string -> string = "#".repeat(string.length());;
