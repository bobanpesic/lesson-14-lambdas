...
public class _3_JobCandidateSelectorUsingLambdas {
	public static void main(String[] args) {
		...
		JobCandidate.jobCandidates.removeIf(jc -> jc.getTeacherName().toLowerCase().contains("joon"));

		JobCandidate.jobCandidates.removeIf(jc -> jc.getTeacherName().toLowerCase().contains("june"));

		JobCandidate.jobCandidates.removeIf(jc -> jc.getTeacherName().toLowerCase().contains("clark"));

		JobCandidate.jobCandidates.removeIf(jc -> jc.getTeacherName().toLowerCase().contains("clarke"));
		System.out.println(JobCandidate.jobCandidates);
